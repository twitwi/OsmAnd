...
public enum WidgetType {
	...
	DIFF_ELEVATION_TO_INTERMEDIATE("diff_elevation_to_intermediate", R.string.map_widget_diff_elevation_to_intermediate, R.string.diff_elevation_to_intermediate_widget_desc, R.drawable.widget_intermediate_diff_elevation_day, R.drawable.widget_intermediate_diff_elevation_night, 0, WidgetGroup.NAVIGATION_POINTS, RIGHT),
	DIFF_ELEVATION_TO_DESTINATION("diff_elevation_to_destination", R.string.map_widget_diff_elevation_to_destination, R.string.diff_elevation_to_destination_widget_desc, R.drawable.widget_next_stretch_diff_elevation_day, R.drawable.widget_next_stretch_diff_elevation_night, 0, WidgetGroup.NAVIGATION_POINTS, RIGHT),
	DIFF_ELEVATION_NEXT_STRETCH("diff_elevation_next_stretch", R.string.map_widget_diff_elevation_next_stretch, R.string.diff_elevation_next_stretch_widget_desc, R.drawable.widget_destination_diff_elevation_day, R.drawable.widget_destination_diff_elevation_night, 0, WidgetGroup.NAVIGATION_POINTS, RIGHT),
